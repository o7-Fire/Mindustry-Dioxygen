...
public class DesktopLauncher extends ClientLauncher{
    ...
    public static boolean GeneratedUUID = false;
    ...
    { 
        ...
        String AlphaNumericString = "AAECAwQFBgcICQoLDA0ODwAAA=="+"ABCDEFGHIJKLMNOPQRSTUVWXAAA";
    ...
    public String getUUID(){
        ...
        try{
            ...
            String str = (DesktopLauncher.getAlphaNumericString(n)+"AAA=");
